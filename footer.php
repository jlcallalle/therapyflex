  ...
  <?php
    ...
    $google_reviews_text = sprintf(
      _n(
        'Basado en %s opinión en Google',
        'Basado en %s opiniones en Google',
        $google_reviews_count,
        'therapyflex'
      ),
      '<strong>' . number_format_i18n($google_reviews_count) . '</strong>'
    );
  ?>
  <section
    class="google-reviews-bar"
    aria-label="Valoración en Google"
>
    <a
        class="google-reviews-bar__content"
        href="https://share.google/oHIJkX0fzVht15OsF"
        target="_blank"
        rel="noopener nofollow"
    >
        <svg
            class="google-reviews-bar__icon"
            width="20"
            height="20"
            viewBox="0 0 48 48"
            aria-hidden="true"
        ...
        <span class="google-reviews-bar__rating">
            <?php echo esc_html(number_format_i18n($google_reviews_rating, 1)); ?>
        </span>

        <span
            class="google-reviews-bar__stars"
            aria-label="<?php echo esc_attr(number_format_i18n($google_reviews_rating, 1) . ' estrellas'); ?>"
        >
            &#9733;&#9733;&#9733;&#9733;&#9733;
        </span>

        <span class="google-reviews-bar__text">
            <?php echo wp_kses_post($google_reviews_text); ?>
        </span>

        <span class="google-reviews-bar__link">
            Ver en Google
