  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-7 mb-5">
        ...
        <?php elseif (isset($_GET['contacto'])) : ?>
          <div class="alert alert-danger">
            Ocurrió un error. Verifica los campos e inténtalo nuevamente.
          </div>
        <?php endif; ?>
        ...
        <form 
          ...
          class="box-contacto p-3 p-md-5"
        >

          <input type="hidden" name="action" value="guardar_contacto_therapyflex">
          <?php wp_nonce_field('therapyflex_contact_action', 'therapyflex_contact_nonce'); ?>

          <div class="row form-group">
            <div class="col-md-6 mb-3 mb-md-0">
              <label class="text-black" for="fname">Nombres</label>
              <input type="text" id="fname" name="nombres" class="form-control" required>
            </div>

            <div class="col-md-6">
              <label class="text-black" for="lname">Apellidos</label>
              <input type="text" id="lname" name="apellidos" class="form-control" required>
            </div>
          </div>
...
<div class="block-cta-1 primary-overlay" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/hero_bg_2.jpg);">
  <div class="container">
    <div class="row align-items-center justify-content-between">
      ...
      <div class="col-lg-4">
        <p class="mb-0">
          <a href="https://wa.me/51920830776?text=Hola%20👋%20Vengo%20de%20la%20web%20de%20Therapy%20Flex%20y%20deseo%20agendar%20una%20cita%20de%20terapia%20física" class="btn btn-outline-white text-white btn-md btn-pill px-5 font-weight-bold btn-block">
            Contáctanos
          </a>
        </p>
      </div>
